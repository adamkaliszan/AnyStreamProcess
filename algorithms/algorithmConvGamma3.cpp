...
convolutionAlgorithmGamma3::convolutionAlgorithmGamma3(): Investigator(QueueServDiscipline::cFIFO)
{
    myQoS_Set
        ...
        )
{
    ...
    for (int i=0; i<m; i++)
    {
        ...
        for (int n=0; n<=VsVb; n++)
        {
            ; //TODO algRes->resultsAS->setVal(resultsType::systemYt_vs_sys_n, a, tmpClass, n, FD->get_y(i, n) * tmpClass->t(), 0);
        }
    }
    deleteTemporaryData();
