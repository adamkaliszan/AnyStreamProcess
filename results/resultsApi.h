...
public:
    ...
    virtual bool getSinglePlot(QLineSeries *outPlot, QPair<double, double> &yMinAndMax, RSystem &rSystem, Investigator *algorithm, const struct ParametersSet &parametersSet, bool linearScale=true) const =0;  //  virtual bool getSinglePlot(QVector<QPair<decimal, double>> &outPlot, QPair<double, double> &yMinAndMax, RSystem &rSystem, Investigator *algorithm, const struct ParametersSet &parametersSet, bool linearScale=true) const {return true;}
    virtual bool getSinglePlot(QVector<QPair<decimal, double>> &outPlot, RSystem &rSystem, Investigator *algorithm, const struct ParametersSet &parametersSet) const = 0;
...
public:
    ...
    bool getSinglePlot(QVector<QPair<decimal, double>> &outPlot, RSystem &rSystem, Investigator *algorithm, const struct ParametersSet &parametersSet) const;
...
public:
    ...
    virtual QMap<ParametersSet, QVector<double>> getPlots(RSystem &rSystem, Type qos, ParameterType functionalParameter, Investigator *algorithm);
